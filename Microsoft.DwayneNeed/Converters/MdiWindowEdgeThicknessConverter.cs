...
namespace Microsoft.DwayneNeed.Converters
{
    ...
    public class MdiWindowEdgeThicknessConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            if ((edges & MdiWindowEdge.Left) == 0) thickness.Left = 0;
            if ((edges & MdiWindowEdge.Top) == 0) thickness.Top = 0;
            if ((edges & MdiWindowEdge.Right) == 0) thickness.Right = 0;
            if ((edges & MdiWindowEdge.Bottom) == 0) thickness.Bottom = 0;
            return thickness;
        }
