...
namespace Microsoft.DwayneNeed.Controls
{
    public class ComponentPresenter : FrameworkElement
    {
        ...
        protected override IEnumerator LogicalChildren
        {
            get
            {
                if (_component != null) yield return _component;
            }
        }
        ...
        {
            if (_component == null || index != 0) throw new ArgumentOutOfRangeException("index");
            return _component;
        }
        ...
        protected override Size ArrangeOverride(Size arrangeSize)
        {
            ...
            if (_component != null) _component.Arrange(new Rect(arrangeSize));
