...
namespace Microsoft.DwayneNeed.Interop
{
    ...
    public class HwndSourceHost : HwndHostEx
    {
        ...
        protected sealed override IEnumerator LogicalChildren
        {
            get
            {
                if (_hwndSource != null) yield return _hwndSource.RootVisual;
            }
        }
        ...
        protected override void Dispose(bool disposing)
        {
            if (disposing)
                ...
                if (_hwndSource != null)
                {
                    ...
                    if (root != null) root.DisposeSubTree();
        ...
        protected override void OnRender(DrawingContext drawingContext)
        {
            ...
            if (Background != null) drawingContext.DrawRectangle(Background, null, new Rect(RenderSize));
        ...
        private void OnChildChanged(DependencyPropertyChangedEventArgs e)
        {
            ...
            if (_hwndSource != null) SetRootVisual(child);
        }
        ...
        private object SetRootVisual(object arg)
        {
            ...
            if (child == null && arg is Uri) child = (FrameworkElement) Application.LoadComponent((Uri) arg);
