...
namespace Microsoft.DwayneNeed.Interop
{
    public sealed class WindowClass<TWindow> : ISupportInitialize where TWindow : WindowBase, new()
    {
        ...
        {
            get => (_wcex.style & CS.DBLCLKS) == CS.DBLCLKS;
        ...
        {
            get => (_wcex.style & CS.VREDRAW) == CS.VREDRAW;
        ...
        {
            get => (_wcex.style & CS.HREDRAW) == CS.HREDRAW;
        ...
        {
            get => (_wcex.style & CS.SAVEBITS) == CS.SAVEBITS;
        ...
        {
            get => (_wcex.style & CS.PARENTDC) == CS.PARENTDC;
        ...
        {
            get => (_wcex.style & CS.DROPSHADOW) == CS.DROPSHADOW;
        ...
        {
            get => (_wcex.style & CS.GLOBALCLASS) == CS.GLOBALCLASS
