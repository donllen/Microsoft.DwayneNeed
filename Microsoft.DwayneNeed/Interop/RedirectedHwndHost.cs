...
namespace Microsoft.DwayneNeed.Interop
{
    public class RedirectedHwndHost : FrameworkElement, IDisposable, IKeyboardInputSink
    {
        ...
        protected virtual void OnCurrentHwndSourceChanged(DependencyPropertyChangedEventArgs e)
        {
            ...
            if (sink != null) ((IKeyboardInputSink) this).KeyboardInputSite = sink.RegisterKeyboardInputSink(this);
        ...
        protected override void OnRenderSizeChanged(SizeChangedInfo sizeInfo)
        {
            ...
            if (IsOutputRedirectionEnabled) UpdateOutputRedirection();
        ...
        private void Initialize()
        {
            ...
            {
                Name = "RedirectedHwndHost",
                Style = WS.OVERLAPPED | WS.CLIPCHILDREN | WS.CAPTION,
                ExtendedStyle = WS_EX.LAYERED | WS_EX.NOACTIVATE | WS_EX.TOOLWINDOW | WS_EX.TRANSPARENT,
                WindowRect = new Int32Rect(0, 0, 500, 500)
            };
                ...
                switch (visibility)
                {
                    ...
                    case RedirectionVisibility.Hidden:
                        _redirectedWindow.Alpha =
                            1; // Not *quite* invisible, which is important so we can still capture content.
                        _redirectedWindow.IsHitTestable = isMouseOver;
                        break;
                }
        }
            ...
            if (currentHwndSource != null)
            {
                ...
                else
                {
                    ...
                    if (hit == this)
                    {
                        ...
                        GeneralTransform xfrm = currentHwndSource.RootVisual.TransformToDescendant(hit);
        ...
        {
            get => (RedirectionVisibility) GetValue(RedirectionVisibilityProperty);
        ...
        {
            get => (bool) GetValue(IsOutputRedirectionEnabledProperty);
        ...
        {
            get => (TimeSpan) GetValue(OutputRedirectionPeriodProperty);
        ...
        {
            get => (bool) GetValue(IsInputRedirectionEnabledProperty);
        ...
        {
            get => (TimeSpan) GetValue(InputRedirectionPeriodProperty);
        ...
        {
            get => (HwndSource) GetValue(CurrentHwndSourceProperty);
        ...
        protected virtual void Dispose(bool disposing)
        {
            ...
            if (disposing)
            {
                ...
                if (_redirectedWindow != null) _redirectedWindow.Dispose();
            }
