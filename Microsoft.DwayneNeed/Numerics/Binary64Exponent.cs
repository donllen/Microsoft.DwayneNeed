...
namespace Microsoft.DwayneNeed.Numerics
{
    ...
    public struct Binary64Exponent
    {
        ...
        {
            if (exponent > 2047) throw new ArgumentOutOfRangeException("exponent");

            _exponent = exponent;
        }

        public uint UnbiasedValue => _exponent;
        public int BiasedValue => (int) _exponent - (int) Bias;
        public Sign Sign => new Sign(_exponent < Bias);
