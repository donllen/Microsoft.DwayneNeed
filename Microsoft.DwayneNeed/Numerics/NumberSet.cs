...
namespace Microsoft.DwayneNeed.Numerics
{
    ...
    public class NumberSet<T> : IEnumerable<T>
    {
        ...
        public Interval<T> Interval => _interval;
        ...
        {
            foreach (T value in _values) yield return value;
        }
        ...
        public bool Add(T value)
        {
            ...
            for (int i = 0; i < _values.Count; i++)
                ...
                else if (nValue < _values[i])
                {
                    ...
                    if (i == 0) _interval = new Interval<T>(_values[0], true, _values[_values.Count - 1], true);
