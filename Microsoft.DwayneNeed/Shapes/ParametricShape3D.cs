    ...
    public abstract class ParametricShape3D : Shape3D
    {
        public static DependencyProperty MinUProperty =
            DependencyProperty.Register(
                ...
                new PropertyMetadata(0.0, OnPropertyChangedAffectsModel));
        ...
        public static DependencyProperty MaxUProperty =
            DependencyProperty.Register(
                ...
                typeof(double),
                typeof(ParametricShape3D),
                new PropertyMetadata(Math.PI * 2, OnPropertyChangedAffectsModel));
        ...
        public static DependencyProperty DivUProperty =
            DependencyProperty.Register(
                ...
                typeof(int),
                typeof(ParametricShape3D),
                new PropertyMetadata(32, OnPropertyChangedAffectsModel));
        ...
        public static DependencyProperty MaxVProperty =
            DependencyProperty.Register(
                ...
                typeof(double),
                typeof(ParametricShape3D),
                new PropertyMetadata(Math.PI, OnPropertyChangedAffectsModel));
        ...
        protected sealed override MeshGeometry3D GetGeometry()
        {
            ...
            for (int iV = 0; iV < divV; iV++)
            {
                ...
                for (int iU = 0; iU < divU; iU++)
                {
                    ...
                    Tuple<int, int, int, int> quad = new Tuple<int, int, int, int>(iPosition, iPosition + stride,
                        iPosition + stride + 1, iPosition + 1);
                    GetTrianglesFromQuad(quad, isNWSE, out Tuple<int, int, int> tri1, out Tuple<int, int, int> tri2);
        ...
        private UIElement GetDefaultMaterial(bool front)
        {
            ...
            for (int iV = 0; iV < divV; iV++)
            {
                ...
                for (int iU = 0; iU < divU; iU++)
                {
                    ...
                    Border b = new Border
                    {
                        Background = useColor ? front ? Brushes.Red : Brushes.AliceBlue : Brushes.Black
                    };
