...
namespace Microsoft.DwayneNeed.Shapes
{
    ...
    public abstract class Shape3D : UIElement3D
    {
        ...
        {
            get => (Transform3D) GetValue(MeshTransformProperty);
        ...
        protected sealed override int Visual3DChildrenCount
        {
            get
            {
                ...
                if (_frontChild != null) numChildren++;

                if (_backChild != null) numChildren++;
        ...
        protected override void OnUpdateModel()
        {
            ...
            if (frontMaterial != null)
            {
                ...
                if (frontGeometry == null) frontMaterial = null;
            }
            ...
            if (backMaterial != null)
            {
                ...
                if (backGeometry == null) backMaterial = null;
            }
        ...
        protected sealed override Visual3D GetVisual3DChild(int index)
        {
            if (index == 0)
            {
                if (_frontChild != null)
                    return _frontChild;
                if (_backChild != null) return _backChild;
            }
            else if (index == 1)
            {
                if (_frontChild != null && _backChild != null) return _backChild;
            }
        ...
        private void EnsureChildren(Shape3DMaterial frontMaterial, Shape3DMaterial backMaterial)
        {
            ...
            {
                if (_frontChild != null) RemoveVisual3DChild(_frontChild);

                _frontChild = frontChild;

                if (_frontChild != null) AddVisual3DChild(_frontChild);
            }

            Visual3D backChild = EnsureChild(_backChild, backMaterial);
            if (backChild != _backChild)
            {
                if (_backChild != null) RemoveVisual3DChild(_backChild);

                _backChild = backChild;

                if (_backChild != null) AddVisual3DChild(_backChild);
            }
        }
        ...
        private static MeshGeometry3D CreateBackGeometry(MeshGeometry3D frontMesh)
        {
            ...
            MeshGeometry3D backMesh = new MeshGeometry3D
            {
                ...
                TriangleIndices = new Int32Collection(frontMesh.TriangleIndices)
            };
            ...
            for (int iNormal = 0; iNormal < numNormals; iNormal++) backMesh.Normals[iNormal] *= -1.0;
